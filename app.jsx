...
const t = {
  ro: {
    ...
    flT: "Linkuri utile", fgT: "Legal", fcT: "Contact",
    fg: [{ h: "#", l: "Confidentialitate" }, { h: "#", l: "Termeni si conditii" }, { h: "#", l: "Cookies" }],
    fComp: "Trademark Alliance SRL", fCUI: "CUI: RO50768537", fRC: "Reg. Com.: J40/24786/2024",
    fAddr: "Str. Aviator Mircea Zorileanu 43, Sector 1, Bucuresti",
  ...
  en: {
    ...
    flT: "Useful links", fgT: "Legal", fcT: "Contact",
    fg: [{ h: "#", l: "Privacy policy" }, { h: "#", l: "Terms & conditions" }, { h: "#", l: "Cookies" }],
    fComp: "Trademark Alliance SRL", fCUI: "VAT: RO50768537", fRC: "Reg. No.: J40/24786/2024",
    fAddr: "Str. Aviator Mircea Zorileanu 43, Sector 1, Bucharest, Romania",
    ...
    <div style={{ fontFamily: ff, background: P.bg, color: P.tx, minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "0 20px", background: scrolled || menuOpen ? "rgba(6,7,13,.96)" : "transparent", backdropFilter: scrolled || menuOpen ? "blur(16px)" : "none", borderBottom: scrolled ? "1px solid rgba(139,92,246,.08)" : "none", transition: TR }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68 }}>
          ...
          <div className="nav-actions" style={{ alignItems: "center", gap: 10 }}>
            {["ro", "en"].map(l => (
          ...
          <button className="nav-burger" onClick={() => setMenuOpen(!menuOpen)} style={{ display: "none", color: P.br, fontSize: 28, lineHeight: 1 }} aria-label="Menu">
            {menuOpen ? "\u2715" : "\u2630"}
          </button>
        </div>
        {/* MOBILE MENU */}
        {menuOpen && (
          <div className="mobile-menu" style={{ flexDirection: "column", padding: "12px 0 20px", borderTop: "1px solid rgba(139,92,246,.08)" }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 16, alignItems: "center" }}>
              {["ro", "en"].map(l => (
                <button key={l} onClick={() => { switchLang(l); setMenuOpen(false); }} style={{ background: lang === l ? "rgba(139,92,246,.15)" : "transparent", color: lang === l ? P.ac : P.dm, border: `1px solid ${lang === l ? P.ac : "rgba(100,116,139,.3)"}`, borderRadius: 6, padding: "6px 14px", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: fm }}>{l.toUpperCase()}</button>
              ))}
            </div>
      ...
      <footer style={{ borderTop: "1px solid rgba(139,92,246,.06)", padding: "50px 28px 36px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", flexWrap: "wrap", gap: 48, justifyContent: "space-between" }}>
          ...
          <div style={{ minWidth: 200 }}>
            <h4 style={{ fontSize: 14, fontWeight: 600, color: P.br, marginBottom: 14 }}>{d.fcT}</h4>
            <p style={{ fontSize: 13, color: P.mu, lineHeight: 1.8, margin: 0 }}>
              <span style={{ fontWeight: 600, color: P.br }}>{d.fComp}</span><br/>
              {d.fCUI}<br/>
              {d.fRC}<br/>
              {d.fAddr}
            </p>
